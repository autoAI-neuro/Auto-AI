        ...
        <>
            ...
            `}>
                <div className="flex flex-col h-full p-4">
                    {/* Logo/Header */}
                    {/* Logo/Header - Zoomed Premium Style */}
                    <div className="mb-6 w-full h-20 relative overflow-hidden flex items-center justify-center">
                        <img
                            src="/logo.png"
                            alt="AUTO AI"
                            className="absolute w-[180%] max-w-none"
                            style={{
                                mixBlendMode: 'screen',
                                left: '50%',
